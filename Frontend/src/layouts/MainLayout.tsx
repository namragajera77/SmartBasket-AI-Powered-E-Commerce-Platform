    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <footer className="border-t border-slate-200/80 bg-white/70 py-8 backdrop-blur-md">
        <div className="container-custom grid gap-4 text-sm text-slate-500 md:grid-cols-2">
          <p className="font-semibold text-slate-800">SmartBasket Commerce Cloud</p>
          <p className="md:text-right">AI search, role-based workflows, and premium checkout built for scale.</p>
        </div>
      </footer>
    </div>
  );
