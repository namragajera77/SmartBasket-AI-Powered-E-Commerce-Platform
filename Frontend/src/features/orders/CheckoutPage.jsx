        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Submit your shipping details to place the order.
            </p>
          </div>
          <div className="inline-flex items-center gap-2 rounded-full bg-slate-100 px-3 py-2 text-xs font-semibold text-slate-600">
            ...
            <span className="rounded-full bg-slate-300 px-2 py-1 text-white">
              2
            </span>
            Confirmation
          </div>
        ...
        >
          ...
          <div className="rounded-2xl border border-orange-100 bg-orange-50 p-4">
            ...
            <p className="mt-2 text-sm text-orange-900">
              Your cart items and total amount will be confirmed in the next
              step.
            </p>
          </div>

          {checkoutMutation.isError ? (
            <ErrorMessage message={checkoutMutation.error.message} />
          ) : null}
          ...
          <Button
            ...
            disabled={
              checkoutMutation.isPending || shippingAddress.trim().length < 8
            }
          >
