...
export function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <EmptyState
        title="Cart is empty"
        message="Add products to your cart to start checkout."
      />
    );
  }
    ...
    <div className="section-stack">
      <Card className="relative overflow-hidden">
        ...
        <p className="mt-1 text-sm text-gray-600">
          Review selected items and continue to checkout.
        </p>
      </Card>
          ...
          {items.map((item) => (
            ...
            >
              <div>
                ...
                <p className="mt-1 inline-flex rounded-full bg-blue-50 px-2 py-1 text-xs font-semibold text-blue-700">
