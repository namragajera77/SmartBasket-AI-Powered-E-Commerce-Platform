    ...
    <div className="section-stack">
      <Card className="space-y-4">
        ...
        <p className="text-sm text-gray-600">
          Create, edit, delete, upload image, and generate AI descriptions from
          one panel.
        </p>
        <form
        ...
        >
          ...
          <Input
            ...
            value={form.price}
            onChange={(event) =>
              setForm((p) => ({ ...p, price: event.target.value }))
            }
          />
          ...
          <Input
            ...
            onChange={(event) =>
              setForm((p) => ({ ...p, stockQuantity: event.target.value }))
            }
          />
          ...
          <div>
            ...
            <select
              ...
              onChange={(event) =>
                setForm((p) => ({ ...p, categoryId: event.target.value }))
              }
            >
      ...
      <Card>
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
          <p className="text-sm text-gray-500">
            Showing page {productsQuery.data?.page ?? page} of{" "}
            {Math.max(
              1,
              Math.ceil(
                (productsQuery.data?.totalItems ?? 0) /
                  (productsQuery.data?.pageSize ?? pageSize),
              ),
            )}
          </p>
          <div className="flex gap-2">
