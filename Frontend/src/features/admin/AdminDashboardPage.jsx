...
export function AdminDashboardPage() {
  ...
  const totalRevenue = (ordersQuery.data ?? []).reduce(
    ...
    <div className="section-stack">
      <Card className="relative overflow-hidden">
        ...
        <p className="mt-1 text-sm text-gray-600">
          Manage catalog, orders, delivery assignment, and AI operations.
        </p>
      </Card>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <Card className="p-6">
          ...
          <p className="mt-3 text-3xl font-bold text-gray-900">
            {ordersQuery.isLoading ? "..." : formatCurrency(totalRevenue)}
          </p>
      ...
      <Card className="p-6">
        ...
        <div className="h-2 w-full overflow-hidden rounded-full bg-slate-100">
          <div
            ...
            style={{
              width: `${Math.min(100, Math.round((totalRevenue / Math.max(totalRevenue, 1000)) * 100))}%`,
            }}
          />
        </div>
      </Card>
